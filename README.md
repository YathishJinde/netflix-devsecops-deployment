    ...
    stages {
        ...
        stage("Docker Build Image"){
            steps{
                ...
                sh "docker build --build-arg API_KEY=squ_c32930c81a1f723864a48373f5778bd169a7b91f -t netflix ."
            }
        }
        stage("TRIVY"){
            steps{
        ...
        stage("Docker Push"){
            steps{
                script {
                    ...
                    sh "docker tag netflix yathishjinde18/netflix:latest "
                    sh "docker push yathishjinde18/netflix:latest"
                    }
                }
            }
        }
